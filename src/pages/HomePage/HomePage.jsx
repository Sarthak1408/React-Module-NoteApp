...
const HomePage = ({noteActive, isPhone}) => {
    ...
    return (
        <>
            <div className={`homepage ${noteGroups && isPhone && noteGroups.length > 0 ? "none" : "flex"}`}>
                <img src={banner} alt="home" width="400px" className="homeImg"/>
                <p className="Title">Pocket Notes</p>
                <p className="Description">
                    Send and receive messages without keeping your phone online <br/>
                    Use Pocket Notes on up to 4 linked devices and 1 mobile phone
                </p>
                <p className="Bottom flex flex-row">
                    <svg
